...
class Vendor(models.Model):
    ...
    vendor_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet="12345678890")
...
class Payout(models.Model):
    ...
    item = models.ForeignKey("home.OrderItem", on_delete=models.SET_NULL, null=True, blank=True, related_name="item")
...
class BankAccount(models.Model):
    ...
    account_type = models.CharField(max_length=30, choices=PAYOUT_METHOD, null=True, blank=True)
...
class Notifications(models.Model):
    ...
    None)
    order = models.ForeignKey("home.OrderItem", on_delete=models.CASCADE, null=True, blank=True)
